...
public interface MoneyTransferRepository {
    MoneyTransferResponse fundTransfer(final AccountsRepositoryInMemory mome,final MoneyTransferRequest moneyTransferRequest) throws InsufficientAmountInAccountException, ExecutionException, InterruptedException;
