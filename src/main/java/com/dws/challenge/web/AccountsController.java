...
public class AccountsController {
    ...
    public MoneyTransferResponse amountTransfer(@Valid @RequestBody MoneyTransferRequest moneyTransferRequest) throws ExecutionException, InterruptedException {
